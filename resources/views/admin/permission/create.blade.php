                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    @if( !empty($permission->id))
                     <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ route('admin.permission.update',array('id'=>$permission->id))}}">
                      <input type="hidden" name="_method" value="put"/>
                    @else
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ url('admin/permission ')}}">
                    @endif
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="display_name" required="required" class="form-control col-md-7 col-xs-12" value="{{$permission->display_name or '' }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text"  name="description" required="required" class="form-control col-md-7 col-xs-12" value="{{$permission->description or '' }}">
                          </textarea>
                        </div>
                      </div>
